...
const CHAPTERS: Chapter[] = [
  {
    ...
    title: (
      <>
        I&rsquo;m Rakesh — an aspiring{" "}
        <em className={styles.serif}>developer.</em>
      </>
    ),
    body: "Full Stack Developer currently seeking an opportunity to contribute, learn, and grow.",
  },
  {
    label: "My Journey",
    title: (
      <>
        I build with the{" "}
        <em className={styles.serif}>MERN stack.</em>
      </>
    ),
    body: "Focused on leveraging my strong skills in React.js, Node.js, Express.js, and MongoDB.",
  },
  {
    label: "Training",
    title: (
      <>
        IBM <em className={`${styles.serif} ${styles.red}`}>SkillsBuild.</em>
      </>
    ),
    body: "Intensive Full Stack Development Training program. Worked on building and optimizing internal tools.",
  }
];
