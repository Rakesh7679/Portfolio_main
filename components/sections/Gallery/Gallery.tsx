 ...
 *
 * Two deliberate departures from the reference, both to keep Rakesh's own
 * photographs intact:
...
export default function Gallery() {
  ...
  /* Columns are computed on the client so the count can follow the viewport.
     Round-robin keeps Rakesh's numbering: 1,2,3,4,5 across the first row,
  ...
  /* deal the 14 frames into columns, round-robin, preserving Rakesh's order */
